          ...
          <div className='pb-8'>
            <div className='flex justify-center items-center h-full'>
              <div className="max-w-full w-[200px]">
                <Image src="/logo.png" alt="logo" width={425} height={86} className='object-contain' />
              </div>
            </div>
            <p className='py-2 text-sm w-full text-center'>Join in on our thriving community</p>
          </div>
